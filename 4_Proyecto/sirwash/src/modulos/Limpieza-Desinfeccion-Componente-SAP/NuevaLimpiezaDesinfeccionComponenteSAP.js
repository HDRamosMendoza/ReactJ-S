...
const URL_01 = "/home";
const NAV_02 = "Limpieza y Desinfección de Componentes del SAP";
const URL_02 = "/ListaDeEncuestas/LimpiezaDesinfeccionComponenteSAP";
const NAV_03 = "Nueva Limpieza y Desinfección de Componente del SAP";
                ...
                <Box gridColumn="span 4">
                  <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gap={2}>
                    <Box gridColumn="span 12">
                      <TextField 
                        select fullWidth 
                        label="Prestador" defaultValue="NA" 
                        helperText="" size="small">
                        {
                          _listaPrestador.map((option) => (
                            <MenuItem key={option.value} value={option.value} >
                              {option.label}
                            </MenuItem>
                          ))
                    ...
                    <Box gridColumn="span 12">
                        <TextField 
                            label="Hipoclorito de Calcio Utilizado (kg.)" 
                            type="number" 
                            color="info" 
                            InputLabelProps={{shrink: true,}} 
                            variant="filled" 
                            fullWidth 
                            sx={{ marginBottom:'0',fontWeight: 'bolder'}} 
                            helperText="Rango de valor: Entre 1 a 10"/>
                    </Box>
