...
const URL_DETALLE = "/ListaDeEncuestas/ContinuidadServicio/DetalleContinuidadServicio";
...
function ListaContinuidadServicio() {
    return (
      <div>
  ...
  export default ListaContinuidadServicio;