...
const URL_DETALLE = "/ListaDeEncuestas/MedicionCloroResidual/DetalleMedicionCloroResidual";
...
function ListaMedicionCloroResidual() {
  return (
    <div>
...
export default ListaMedicionCloroResidual;